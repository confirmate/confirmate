<script lang="ts">
	...
	let {
		...
		open: boolean;
		control: { id: string; name: string; description?: string; categoryName?: string; categoryCatalogId?: string; parentControlId?: string };
	...
	<div class="fixed inset-0 z-50 flex items-center justify-center">
		...
		<div class="relative z-10 w-full max-w-2xl max-h-[80vh] overflow-y-auto rounded-lg bg-white p-6 shadow-xl">
			<div class="mb-4 flex items-center justify-between">
				<h3 class="text-lg font-semibold">Evaluation Details: {control.id}</h3>
