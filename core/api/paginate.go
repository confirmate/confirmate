...
// ListAllPaginated invokes a List RPC function that supports pagination, fetches all pages using
// individual calls and finally combines all results of all pages into a single slice. It executes
