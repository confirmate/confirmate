// Copyright 2021-2025 Fraunhofer AISEC
//
...
type Metric struct {
	...
	Scale Metric_Scale `protobuf:"varint,5,opt,name=scale,proto3,enum=confirmate.assessment.v1.Metric_Scale" json:"scale,omitempty"`
...
const file_api_assessment_metric_proto_rawDesc = "" +
	"\n" +
	"\x1bapi/assessment/metric.proto\x12\x18confirmate.assessment.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x13tagger/tagger.proto\"\xc4\x05\n" +
	"\x06Metric\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	...
	"\bcategory\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\bcategory\x12F\n" +
	"\x05scale\x18\x05 \x01(\x0e2&.confirmate.assessment.v1.Metric.ScaleB\b\xbaH\x05\x82\x01\x02\x10\x01R\x05scale\x12=\n" +
	"\x05range\x18\x06 \x01(\v2\x1f.confirmate.assessment.v1.RangeB\x06\xbaH\x03\xc8\x01\x01R\x05range\x12f\n" +
	"\binterval\x18\a \x01(\v2\x19.google.protobuf.DurationB/\x9a\x84\x9e\x03*gorm:\"serializer:durationpb;type:interval\"R\binterval\x12[\n" +
	"\x0eimplementation\x18\b \x01(\v2..confirmate.assessment.v1.MetricImplementationH\x00R\x0eimplementation\x88\x01\x01\x12}\n" +
	...
	"\x11_deprecated_since\"\xd8\x01\n" +
	"\x05Range\x12P\n" +
	"\x0eallowed_values\x18\x01 \x01(\v2'.confirmate.assessment.v1.AllowedValuesH\x00R\rallowedValues\x127\n" +
	"\x05order\x18\x02 \x01(\v2\x1f.confirmate.assessment.v1.OrderH\x00R\x05order\x12;\n" +
	"\amin_max\x18\x03 \x01(\v2 .confirmate.assessment.v1.MinMaxH\x00R\x06minMaxB\a\n" +
	"\x05range\",\n" +
	"\x06MinMax\x12\x10\n" +
	...
	"\rLANGUAGE_REGO\x10\x01B#Z!confirmate.io/core/api/assessmentb\x06proto3"
...
var file_api_assessment_metric_proto_goTypes = []any{
	(Metric_Scale)(0),                  // 0: confirmate.assessment.v1.Metric.Scale
	(MetricImplementation_Language)(0), // 1: confirmate.assessment.v1.MetricImplementation.Language
	(*Metric)(nil),                     // 2: confirmate.assessment.v1.Metric
	(*Range)(nil),                      // 3: confirmate.assessment.v1.Range
	(*MinMax)(nil),                     // 4: confirmate.assessment.v1.MinMax
	(*AllowedValues)(nil),              // 5: confirmate.assessment.v1.AllowedValues
	(*Order)(nil),                      // 6: confirmate.assessment.v1.Order
	(*MetricConfiguration)(nil),        // 7: confirmate.assessment.v1.MetricConfiguration
	(*MetricImplementation)(nil),       // 8: confirmate.assessment.v1.MetricImplementation
	(*durationpb.Duration)(nil),        // 9: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),      // 10: google.protobuf.Timestamp
	(*structpb.Value)(nil),             // 11: google.protobuf.Value
}
var file_api_assessment_metric_proto_depIdxs = []int32{
	0,  // 0: confirmate.assessment.v1.Metric.scale:type_name -> confirmate.assessment.v1.Metric.Scale
	3,  // 1: confirmate.assessment.v1.Metric.range:type_name -> confirmate.assessment.v1.Range
	9,  // 2: confirmate.assessment.v1.Metric.interval:type_name -> google.protobuf.Duration
	8,  // 3: confirmate.assessment.v1.Metric.implementation:type_name -> confirmate.assessment.v1.MetricImplementation
	10, // 4: confirmate.assessment.v1.Metric.deprecated_since:type_name -> google.protobuf.Timestamp
	5,  // 5: confirmate.assessment.v1.Range.allowed_values:type_name -> confirmate.assessment.v1.AllowedValues
	6,  // 6: confirmate.assessment.v1.Range.order:type_name -> confirmate.assessment.v1.Order
	4,  // 7: confirmate.assessment.v1.Range.min_max:type_name -> confirmate.assessment.v1.MinMax
	11, // 8: confirmate.assessment.v1.AllowedValues.values:type_name -> google.protobuf.Value
	11, // 9: confirmate.assessment.v1.Order.values:type_name -> google.protobuf.Value
	11, // 10: confirmate.assessment.v1.MetricConfiguration.target_value:type_name -> google.protobuf.Value
	10, // 11: confirmate.assessment.v1.MetricConfiguration.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 12: confirmate.assessment.v1.MetricImplementation.lang:type_name -> confirmate.assessment.v1.MetricImplementation.Language
	10, // 13: confirmate.assessment.v1.MetricImplementation.updated_at:type_name -> google.protobuf.Timestamp
