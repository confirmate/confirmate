...
const file_api_ontology_service_proto_rawDesc = "" +
	"\n" +
	"\x1aapi/ontology/service.proto\x12\x16confirmate.ontology.v1\x1a5policies/security-metrics/ontology/1.0/ontology.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"K\n" +
	"\vNoopRequest\x12<\n" +
	"\bresource\x18\x01 \x01(\v2 .confirmate.ontology.v1.ResourceR\bresource2{\n" +
	"\x0fOntologyService\x12h\n" +
	"\x04Noop\x12#.confirmate.ontology.v1.NoopRequest\x1a\x16.google.protobuf.Empty\"#\x82\xd3\xe4\x93\x02\x1d:\bresource\"\x11/v1/ontology/noopB!Z\x1fconfirmate.io/core/api/ontologyb\x06proto3"
...
func file_api_ontology_service_proto_init() {
	...
	file_policies_security_metrics_ontology_1_0_ontology_proto_init()
	type x struct{}
