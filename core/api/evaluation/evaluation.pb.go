...
type EvaluationResult struct {
	...
	ControlId string `protobuf:"bytes,4,opt,name=control_id,json=controlId,proto3" json:"control_id,omitempty" gorm:"index:idx_evaluation_results_control_timestamp,priority:1"`
	...
	// Time of evaluation
	Timestamp *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=timestamp,proto3" json:"timestamp,omitempty" gorm:"serializer:timestamppb;type:timestamp;index:idx_evaluation_results_control_timestamp,priority:2"`
...
func (x *EvaluationJob) GetInterval() int32 {
	if x != nil {
		return x.Interval
	}
	return 0
...
type ListEvaluationJobsRequest_Filter struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional, if provided, filters the evaluation jobs by the given audit scope ID.
...
func (x *ListEvaluationJobsRequest_Filter) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_api_evaluation_evaluation_proto_rawDesc = "" +
	...
	"\x0fevaluation_jobs\x18\x01 \x03(\v2'.confirmate.evaluation.v1.EvaluationJobR\x0eevaluationJobs\"\xd7\a\n" +
	...
	"\x0eaudit_scope_id\x18\x03 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\fauditScopeId\x12k\n" +
	"\n" +
	"control_id\x18\x04 \x01(\tBL\xbaH\x04r\x02\x10\x01\x9a\x84\x9e\x03@gorm:\"index:idx_evaluation_results_control_timestamp,priority:1\"R\tcontrolId\x125\n" +
	...
	"\x06status\x18\b \x01(\x0e2*.confirmate.evaluation.v1.EvaluationStatusB\v\xe0A\x02\xbaH\x05\x82\x01\x02\x10\x01R\x06status\x12\xa8\x01\n" +
	"\ttimestamp\x18\t \x01(\v2\x1a.google.protobuf.TimestampBn\xe0A\x02\x9a\x84\x9e\x03fgorm:\"serializer:timestamppb;type:timestamp;index:idx_evaluation_results_control_timestamp,priority:2\"R\ttimestamp\x12^\n" +
