...
func (svc *Service) CreateTargetOfEvaluation(
	...
	go svc.publishEvent(&orchestrator.ChangeEvent{
		Type: orchestrator.ChangeEvent_TYPE_TARGET_OF_EVALUATION_CHANGE,
		Event: &orchestrator.ChangeEvent_TargetOfEvaluationChange{
			TargetOfEvaluationChange: &orchestrator.TargetOfEvaluationChangeEvent{
				Type:               orchestrator.TargetOfEvaluationChangeEvent_TYPE_CREATED,
...
func (svc *Service) UpdateTargetOfEvaluation(
	...
	go svc.publishEvent(&orchestrator.ChangeEvent{
		...
		Event: &orchestrator.ChangeEvent_TargetOfEvaluationChange{
			TargetOfEvaluationChange: &orchestrator.TargetOfEvaluationChangeEvent{
				Type:               orchestrator.TargetOfEvaluationChangeEvent_TYPE_UPDATED,
				TargetOfEvaluation: toe,
			},
		},
	})
...
func (svc *Service) RemoveTargetOfEvaluation(
	...
	go svc.publishEvent(&orchestrator.ChangeEvent{
		...
		Event: &orchestrator.ChangeEvent_TargetOfEvaluationChange{
			TargetOfEvaluationChange: &orchestrator.TargetOfEvaluationChangeEvent{
				Type:               orchestrator.TargetOfEvaluationChangeEvent_TYPE_REMOVED,
				TargetOfEvaluation: &toe,
			},
		},
	})
