...
// Source: https://raw.githubusercontent.com/gophercloud/gophercloud/refs/heads/main/openstack/containerinfra/v1/clusters/testing/fixtures_test.go (2025-06-04)
//
// Changes:
...
var UpdateClusterResponse = fmt.Sprintf(`
{
	"uuid":"%s"
}`, clusterUUID)
...
func HandleUpdateClusterSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/clusters/"+clusterUUID, func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprint(w, UpdateClusterResponse)
	})
}
